...
Java_com_fl_flib_Utils_saveSound(JNIEnv *env, jclass cls, jstring path_jstr, jint type, jstring save_jstr) {
    Sound *sound;
    DSP *dsp;
    bool playing = true;
    float frequency = 0;
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_fl_flib_Utils_playSound(JNIEnv *env, jclass cls, jstring path_jstr, jint type) {
    Sound *sound;
    DSP *dsp;
    bool playing = true;
    float frequency = 0;
...
Java_com_fl_flib_Utils_stopPlay(JNIEnv *env, jclass jcls) {
    LOGI("%s", "stopPlay")
    channel->stop();
}

extern "C" JNIEXPORT void JNICALL
Java_com_fl_flib_Utils_resumePlay(JNIEnv *env, jclass jcls) {
    LOGI("%s", "resumePlay")
...
extern "C" JNIEXPORT void JNICALL
Java_com_fl_flib_Utils_pausePlay(JNIEnv *env, jclass jcls) {
    LOGI("%s", "pausePlay")
    channel->setPaused(true);
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_fl_flib_Utils_isPlaying(JNIEnv *env, jclass jcls) {
    LOGI("%s", "isPlaying")
    bool isPlaying = true;
